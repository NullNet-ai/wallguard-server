...
pub mod wall_guard_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn authenticate(
            ...
            tonic::Response<tonic::codec::Streaming<super::AuthenticationResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/wallguard.WallGuard/Authenticate",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("wallguard.WallGuard", "Authenticate"));
...
pub mod wall_guard_server {
    ...
    pub trait WallGuard: std::marker::Send + std::marker::Sync + 'static {
        ...
        type AuthenticateStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::AuthenticationResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/wallguard.WallGuard/Authenticate" => {
                    ...
                    struct AuthenticateSvc<T: WallGuard>(pub Arc<T>);
                    impl<
                        T: WallGuard,
                    > tonic::server::ServerStreamingService<super::AuthenticateRequest>
                    for AuthenticateSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as WallGuard>::authenticate(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
