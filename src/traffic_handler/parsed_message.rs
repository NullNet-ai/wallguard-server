use crate::traffic_handler::connections_map::{ConnectionKey, ConnectionValue};
use serde::Serialize;
...
mod tests {
    use super::*;
    use crate::traffic_handler::ip_header::IpHeader;
    use crate::traffic_handler::transport_header::{Protocol, TransportHeader};
    use std::net::IpAddr;
    use std::str::FromStr;
