...
mod tests {
    ...
    const RECORD_1_JSON: &'static str = r#"{"device_id":"machine-id-1234","interface_name":"eth0","source_ip":"8.8.8.8","destination_ip":"9.9.9.9","source_port":443,"destination_port":50051,"protocol":"tcp","timestamp":"2021-08-01T00:00:00Z","packets":11,"byte_data":1528,"remote_ip":"8.8.8.8"}"#;

    const RECORD_2_JSON: &'static str = r#"{"device_id":"machine-id-5678","interface_name":"eth0","source_ip":"8.8.8.8","destination_ip":"9.9.9.9","protocol":"icmpv4","timestamp":"2022-09-01T00:00:00Z","packets":1,"byte_data":77}"#;
